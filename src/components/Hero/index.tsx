        ...
        <div className="container">
          ...
          <div className="hero-content">
            ...
            <p className="hero-text">
              Diseñamos y desarrollamos aplicaciones web de software a medida, enfocados en eficiencia, innovación y resultados. Lleva tu empresa al futuro con herramientas digitales personalizadas para cada desafío            
            </p>
