        ...
        <div className="container">
          ...
          <div className="hero-content">
            ...
            <p className="hero-text">
              Diseñamos y desarrollamos aplicaciones web de software a medida, enfocados ejsdcsakufdifb resultados. Lleva tu empresa al futuro con herramientas digitales personalizadas para cada desafío            
            </p>
            ...
            <div className="wrapper">
              ...
              <button className="hero-btn" aria-label="Green Studios promo">
                ...
                <span className="span">Behind</span>
              </button>
            </div>
